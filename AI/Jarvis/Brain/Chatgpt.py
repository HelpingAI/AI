...
try:
    ...
    chrome_driver_path = 'Jarvis\\Brain\\chromedriver.exe'
...
def FileReader():
    ...
    try:
        File = open("Jarvis\\Brain\\Chatnumber.txt","r")
        Data = File.read()
        File.close()
        return Data
...
def FileWriter(Data):
    ...
    try:
        File = open("Jarvis\\Brain\\Chatnumber.txt","w")
        File.write(Data)
        File.close()
...
def MainExecutionChatGPT():
    ...
    while True:
        ...
        try:
            File = open("Jarvis\\Body\\SpeechRecognition.txt","r")
            Data = File.read()
            File.close()
            FileHistory = open("Jarvis\\Brain\\HistoryChat.txt","r")
            ...
            if str(Data) == str(DataHistory):
                ...
                FileHistory = open("Jarvis\\Brain\\HistoryChat.txt","w")
